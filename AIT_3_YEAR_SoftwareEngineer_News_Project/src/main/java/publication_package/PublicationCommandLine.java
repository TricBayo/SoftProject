...
public class PublicationCommandLine implements CommandLinesExecution {
	...
	private void publicationFunctionalities() {
		System.out.println();
		System.out.println("========== Publication Entity Menu ==========");
				...
				case "3":
					...
					if (resultSet != null) {
						...
						while (resultSet.next()) {
							...
							System.out.println("Name: " + resultSet.getString("publication_name"));
							System.out.println("Date: " + resultSet.getString("publication_date"));
							System.out.println("Stock: " + resultSet.getInt("stock_amount"));
							System.out.println("Price: " + resultSet.getDouble("edition_price"));
